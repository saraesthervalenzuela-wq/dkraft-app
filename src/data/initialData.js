...
export const navSections = [
    ...
    },
    {
        ...
        items: [
            ...
            { id: 'bom', label: 'Bill of Material (BOM)', icon: 'receipt_long' },
        ]
    },
    {
        id: 'production',
...
export const bomStatusOptions = ['Active', 'Draft', 'Obsolete'];
export const componentTypeOptions = ['material', 'subassembly'];

// BOM Data - Multi-level structure
export const bomData = [
    {
        id: 1,
        code: 'BOM-001',
        name: 'Executive Desk Complete',
        productId: 1,
        productName: 'Executive Desk',
        description: 'Complete BOM for executive desk with storage',
        version: '1.0',
        status: 'Active',
        components: [
            {
            ...
            },
            {
                ...
                type: 'material',
                itemId: 4,
                itemName: 'Telescopic Slide 45cm',
                itemCode: 'MAT-004',
                quantity: 6,
                unit: 'Pair',
                unitCost: 120.00,
        ...
        totalMaterialCost: 4340.00,
        laborCost: 800.00,
        overheadCost: 360.00,
        totalCost: 5500.00,
        margin: 35,
        suggestedPrice: 8500.00,
    ...
    },
    {
        ...
        productId: null,
        productName: 'Custom Kitchen Set',
        description: 'Full kitchen cabinet system with upper and lower units',
        version: '2.1',
        status: 'Active',
        components: [
            {
            ...
            },
            {
                ...
                stockAvailable: 500,
                stockStatus: 'sufficient',
                notes: 'Door hinges - all cabinets'
            },
            {
                id: 'comp-103',
                type: 'material',
                ...
                notes: 'ATTENTION: Need to order more!'
            },
            {
                id: 'comp-104',
                type: 'material',
                itemId: 7,
                itemName: 'Tempered Glass 6mm',
                itemCode: 'MAT-007',
                quantity: 4,
                unit: 'sqm',
                unitCost: 850.00,
            ...
            },
            {
                ...
                stockStatus: 'n/a',
                subBomId: 4,
                notes: 'Standard drawer unit'
            }
        ],
        totalMaterialCost: 20100.00,
        laborCost: 3500.00,
        overheadCost: 1800.00,
        totalCost: 25400.00,
        margin: 40,
        suggestedPrice: 42000.00,
    ...
    },
    {
        ...
        productId: 3,
        productName: '5-Tier Modular Bookshelf',
        ...
        totalMaterialCost: 3220.00,
        laborCost: 400.00,
        overheadCost: 180.00,
        totalCost: 3800.00,
        margin: 30,
        suggestedPrice: 5400.00,
    ...
    },
    {
        id: 4,
        code: 'SUB-001',
        name: 'Standard Drawer Unit',
        productId: null,
        productName: 'Sub-assembly',
        description: 'Standard drawer unit for kitchen cabinets',
        version: '1.0',
        status: 'Active',
        components: [
            {
    ...
    },
    {
        ...
        productId: 4,
        productName: '8-Person Conference Table',
        description: 'Large conference table with metal base',
        version: '1.2',
        status: 'Draft',
        components: [
            {
            ...
            },
            {
                ...
                stockAvailable: 25,
                stockStatus: 'sufficient',
                notes: 'Finishing - multiple coats'
            },
            {
                id: 'comp-403',
                type: 'material',
        ...
        totalMaterialCost: 6810.00,
        laborCost: 1200.00,
        overheadCost: 490.00,
        totalCost: 8500.00,
        margin: 45,
        suggestedPrice: 15500.00,
