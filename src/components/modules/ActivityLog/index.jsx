...
/**
 * Normalize an activity row to the shape the UI expects.
 * Handles the REST API (camelCase) and Supabase (snake_case columns:
 * action, entity_type, entity_id, user_id, new_data, created_at).
 */
const normalizeActivity = (a) => ({
    id: a.id,
    action: (a.action || '').toLowerCase(),
    module: a.module || a.entity_type || '',
    entityId: a.entityId || a.entity_id || '',
    entityName: a.entityName || a.entity_name || a.entity_id || '',
    user: a.user || a.user_name || a.user_id || 'System',
    userId: a.userId || a.user_id || '',
    timestamp: a.timestamp || a.created_at,
    changes: a.changes || a.new_data || {},
});
