...
/**
 * Normalize a project row to the camelCase shape used by the UI.
 * Handles both the REST API (camelCase) and Supabase (snake_case columns).
 */
const normalizeProject = (p) => ({
    ...
    terms: p.terms || '',
    nameAddress: p.nameAddress || p.name_address || '',
    shipTo: p.shipTo || p.ship_to || '',
    contact: p.contact || '',
    salesRep: p.salesRep || '',
    csr: p.csr || '',
...
const ProjectsModule = () => {
    ...
    // Load from API or Supabase on mount
    useEffect(() => {
