...
const dummyQuotations = [
    {
        ...
        items: [
            { id: 'item-1', productId: 'p1', productName: 'Metal Structure Type A', description: 'Structure fabrication', quantity: 5, unitPrice: 12000, discount: 0, subtotal: 60000 },
            { id: 'item-2', productId: 'p2', productName: 'Specialized Welding', description: 'MIG welding service', quantity: 10, unitPrice: 2500, discount: 0, subtotal: 25000 },
        ],
    },
    {
        id: 'demo-2',
        ...
        items: [
            { id: 'item-3', productId: 'p3', productName: 'Turned Parts', description: 'CNC precision turning', quantity: 100, unitPrice: 450, discount: 0, subtotal: 45000 },
        ],
    },
    {
        id: 'demo-3',
        ...
        items: [
            { id: 'item-4', productId: 'p4', productName: 'Laser Cutting', description: 'Sheet metal cutting gauge 14', quantity: 50, unitPrice: 400, discount: 0, subtotal: 20000 },
            { id: 'item-5', productId: 'p5', productName: 'Industrial Bending', description: 'CNC bending', quantity: 40, unitPrice: 300, discount: 0, subtotal: 12000 },
        ],
    },
    {
        id: 'demo-4',
        ...
        items: [
            { id: 'item-6', productId: 'p6', productName: 'Complete CNC Machining', description: 'Component manufacturing', quantity: 25, unitPrice: 6000, discount: 0, subtotal: 150000 },
        ],
    },
    {
        id: 'demo-5',
        ...
        items: [
            { id: 'item-7', productId: 'p7', productName: 'Electromechanical Assembly', description: 'System assembly', quantity: 8, unitPrice: 5500, discount: 0, subtotal: 44000 },
            { id: 'item-8', productId: 'p8', productName: 'Industrial Wiring', description: 'Electrical installation', quantity: 12, unitPrice: 2000, discount: 0, subtotal: 24000 },
        ],
    },
    {
        id: 'demo-6',
        ...
        items: [
            { id: 'item-9', productId: 'p9', productName: 'Storage Tank', description: 'Stainless steel tank 500L', quantity: 3, unitPrice: 18000, discount: 0, subtotal: 54000 },
            { id: 'item-10', productId: 'p10', productName: 'Industrial Valves', description: 'Control valves', quantity: 6, unitPrice: 3000, discount: 0, subtotal: 18000 },
        ],
    },
    {
        id: 'demo-7',
        ...
        items: [
            { id: 'item-11', productId: 'p11', productName: 'Machinery Spare Parts', description: 'Replacement parts', quantity: 15, unitPrice: 1900, discount: 0, subtotal: 28500 },
        ],
    },
    {
        id: 'demo-8',
        ...
        items: [
            { id: 'item-12', productId: 'p12', productName: 'Industrial Tooling', description: 'Special tools kit', quantity: 20, unitPrice: 4750, discount: 0, subtotal: 95000 },
        ],
    },
];
